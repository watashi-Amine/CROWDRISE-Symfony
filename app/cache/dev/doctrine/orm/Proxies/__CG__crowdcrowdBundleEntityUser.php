...
class User extends \crowd\crowdBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'crowd\\crowdBundle\\Entity\\User' . "\0" . 'dateInscription', 'path', 'file', '' . "\0" . 'crowd\\crowdBundle\\Entity\\User' . "\0" . 'temp', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }

        return ['__isInitialized__', 'id', '' . "\0" . 'crowd\\crowdBundle\\Entity\\User' . "\0" . 'dateInscription', 'file', '' . "\0" . 'crowd\\crowdBundle\\Entity\\User' . "\0" . 'temp', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
    }
