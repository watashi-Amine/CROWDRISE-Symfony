...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ccdn_forum_forum.component.twig_extension.forum_global' => 'getCcdnForumForum_Component_TwigExtension_ForumGlobalService',
            ...
            'templating.asset.package.avatars.http' => 'getTemplating_Asset_Package_Avatars_HttpService',
            'templating.asset.package.avatars.ssl' => 'getTemplating_Asset_Package_Avatars_SslService',
            ...
            'vich_uploader.namer_uniqid.projet_file' => 'getVichUploader_NamerUniqid_ProjetFileService',
            'vich_uploader.namer_uniqid.projet_image' => 'getVichUploader_NamerUniqid_ProjetImageService',
    ...
    {
        return $this->services['ccdn_forum_forum.component.crumb_factory'] = new \CCDNForum\ForumBundle\Component\Crumbs\Factory\CrumbFactory($this->get('translator'), $this->get('router'));
    }
    ...
    {
        return $this->services['ccdn_forum_forum.component.helper.role'] = new \CCDNForum\ForumBundle\Component\Helper\RoleHelper($this->get('security.context'), array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    /**
     * Gets the 'ccdn_forum_forum.component.twig_extension.forum_global' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CCDNForum\ForumBundle\Component\TwigExtension\ForumGlobalExtension A CCDNForum\ForumBundle\Component\TwigExtension\ForumGlobalExtension instance.
     */
    protected function getCcdnForumForum_Component_TwigExtension_ForumGlobalService()
    {
        return $this->services['ccdn_forum_forum.component.twig_extension.forum_global'] = new \CCDNForum\ForumBundle\Component\TwigExtension\ForumGlobalExtension($this);
    }
    ...
    protected function getDebug_Templating_Engine_PhpService()
    {
        ...
        $instance->setHelpers(array('slots' => 'templating.helper.slots', 'assets' => 'templating.helper.assets', 'request' => 'templating.helper.request', 'session' => 'templating.helper.session', 'router' => 'templating.helper.router', 'actions' => 'templating.helper.actions', 'code' => 'templating.helper.code', 'translator' => 'templating.helper.translator', 'form' => 'templating.helper.form', 'stopwatch' => 'templating.helper.stopwatch', 'logout_url' => 'templating.helper.logout_url', 'security' => 'templating.helper.security', 'assetic' => 'assetic.helper.dynamic', 'vich_uploader' => 'vich_uploader.templating.helper.uploader_helper', 'ivory_google_map' => 'ivory_google_map.template.helper', 'jms_serializer' => 'jms_serializer.templating.helper.serializer'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addResolveTargetEntity('Symfony\\Component\\Security\\Core\\User\\UserInterface', 'crowd\\crowdBundle\\Entity\\User', array());

        $g = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this);
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('Projet_file', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('Projet_image', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('Projet_file', $e, $a, $b));
        $g->addEventSubscriber(new \FOS\UserBundle\Doctrine\UserListener($this));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('Projet_image', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('Projet_image', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('Projet_file', $e, $a, $b));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'bk', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $d, $g, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\vendor\\codeconsortium\\ccdn-forum-bundle\\CCDNForum\\ForumBundle\\Resources\\config\\doctrine') => 'CCDNForum\\ForumBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\egeloen\\google-map-bundle\\Resources\\config\\doctrine') => 'Ivory\\GoogleMapBundle\\Entity', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\comment-bundle\\FOS\\CommentBundle\\Resources\\config\\doctrine') => 'FOS\\CommentBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\crowd\\crowdBundle\\Entity'))), 'crowd\\crowdBundle\\Entity');
        $c->addDriver($a, 'CCDNForum\\ForumBundle\\Entity');
        $c->addDriver($b, 'Ivory\\GoogleMapBundle\\Entity');
        $c->addDriver($b, 'FOS\\CommentBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('crowdBundle' => 'crowd\\crowdBundle\\Entity', 'CCDNForumForumBundle' => 'CCDNForum\\ForumBundle\\Entity', 'IvoryGoogleMapBundle' => 'Ivory\\GoogleMapBundle\\Entity', 'FOSCommentBundle' => 'FOS\\CommentBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_41bd1296593d6e7a6299ff3d99a8f62a950df5289360be9a5247e00e9523de00');
    ...
    {
        return $this->services['fos_comment.acl.comment'] = new \FOS\CommentBundle\Acl\RoleCommentAcl($this->get('security.authorization_checker'), 'IS_AUTHENTICATED_ANONYMOUSLY', 'IS_AUTHENTICATED_ANONYMOUSLY', 'IS_AUTHENTICATED_ANONYMOUSLY', 'ROLE_ADMIN', 'crowd\\crowdBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.acl.thread'] = new \FOS\CommentBundle\Acl\RoleThreadAcl($this->get('security.authorization_checker'), 'IS_AUTHENTICATED_ANONYMOUSLY', 'IS_AUTHENTICATED_ANONYMOUSLY', 'IS_AUTHENTICATED_ANONYMOUSLY', 'ROLE_ADMIN', 'crowd\\crowdBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.acl.vote'] = new \FOS\CommentBundle\Acl\RoleVoteAcl($this->get('security.authorization_checker'), 'IS_AUTHENTICATED_ANONYMOUSLY', 'IS_AUTHENTICATED_ANONYMOUSLY', 'IS_AUTHENTICATED_ANONYMOUSLY', 'ROLE_ADMIN', 'crowd\\crowdBundle\\Entity\\Vote');
    }
    ...
    {
        return $this->services['fos_comment.form_type.comment.default'] = new \FOS\CommentBundle\Form\CommentType('crowd\\crowdBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.form_type.commentable_thread.default'] = new \FOS\CommentBundle\Form\CommentableThreadType('crowd\\crowdBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.form_type.delete_comment.default'] = new \FOS\CommentBundle\Form\DeleteCommentType('crowd\\crowdBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.form_type.thread.default'] = new \FOS\CommentBundle\Form\ThreadType('crowd\\crowdBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.form_type.vote.default'] = new \FOS\CommentBundle\Form\VoteType('crowd\\crowdBundle\\Entity\\Vote');
    }
    ...
    {
        return $this->services['fos_comment.manager.comment.default'] = new \FOS\CommentBundle\Entity\CommentManager($this->get('debug.event_dispatcher'), $this->get('fos_comment.sorting_factory'), $this->get('fos_comment.entity_manager'), 'crowd\\crowdBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.manager.thread.default'] = new \FOS\CommentBundle\Entity\ThreadManager($this->get('debug.event_dispatcher'), $this->get('fos_comment.entity_manager'), 'crowd\\crowdBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.manager.vote.default'] = new \FOS\CommentBundle\Entity\VoteManager($this->get('debug.event_dispatcher'), $this->get('fos_comment.entity_manager'), 'crowd\\crowdBundle\\Entity\\Vote');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('crowd\\crowdBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('adel.b.jemaa@gmail.com' => 'Example.com'), 'resetting' => array('adel.b.jemaa@gmail.com' => 'Example.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('crowd\\crowdBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('crowd\\crowdBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('crowd\\crowdBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'crowd\\crowdBundle\\Entity\\User');
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\framework-extra-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'\\src\\AppBundle/Resources/config/serializer'), 'crowd\\crowdBundle' => ($this->targetDirs[3].'\\src\\crowd\\crowdBundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/config/serializer'), 'admin\\adminBundle' => ($this->targetDirs[3].'\\src\\admin\\adminBundle/Resources/config/serializer'), 'Vich\\UploaderBundle' => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/config/serializer'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/config/serializer'), 'CCDNForum\\ForumBundle' => ($this->targetDirs[3].'\\vendor\\codeconsortium\\ccdn-forum-bundle\\CCDNForum\\ForumBundle/Resources/config/serializer'), 'Ob\\HighchartsBundle' => ($this->targetDirs[3].'\\vendor\\ob\\highcharts-bundle/Resources/config/serializer'), 'Ivory\\GoogleMapBundle' => ($this->targetDirs[3].'\\vendor\\egeloen\\google-map-bundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\rest-bundle\\FOS\\RestBundle/Resources/config/serializer'), 'FOS\\CommentBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\comment-bundle\\FOS\\CommentBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle/Resources/config/serializer'), 'Acme\\DemoBundle' => ($this->targetDirs[3].'\\src\\Acme\\DemoBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\generator-bundle\\Sensio\\Bundle\\GeneratorBundle/Resources/config/serializer')));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \crowd\crowdBundle\Redirection\AfterLoginRedirection A crowd\crowdBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \crowd\crowdBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $l, array(), $a);
        $n->setOptions(array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $l, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('redirect.after.login'), array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $n, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5738e3be420d72.83948813', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, '/login', false), NULL, NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('adel.b.jemaa@gmail.com');
        $a->setPassword('jat03051993tyghbn');
        $a->setAuthMode(NULL);
    ...
    /**
     * Gets the 'templating.asset.package.avatars.http' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getTemplating_Asset_Package_Avatars_HttpService()
    {
        return $this->services['templating.asset.package.avatars.http'] = new \Symfony\Component\Templating\Asset\UrlPackage(array(0 => '/1/uploadsProjets'), NULL, '%s?%s');
    }

    /**
     * Gets the 'templating.asset.package.avatars.ssl' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * 
     * @throws InactiveScopeException when the 'templating.asset.package.avatars.ssl' service is requested while the 'request' scope is not active
     */
    protected function getTemplating_Asset_Package_Avatars_SslService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('templating.asset.package.avatars.ssl', 'request');
        }

        return $this->services['templating.asset.package.avatars.ssl'] = $this->scopedServices['request']['templating.asset.package.avatars.ssl'] = new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($this->get('request'), NULL, '%s?%s');
    }
    ...
    protected function getTemplating_Helper_AssetsService()
    {
        ...
        return $this->services['templating.helper.assets'] = $this->scopedServices['request']['templating.helper.assets'] = new \Symfony\Component\Templating\Helper\CoreAssetsHelper(new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($a, NULL, '%s?%s'), array('avatars' => $this->get('templating.asset.package_factory')->getPackage($a, 'templating.asset.package.avatars.http', 'templating.asset.package.avatars.ssl')));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\crowd\\crowdBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ky.yml'), 'ky', 'FOSUserBundle');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ky.yml'), 'ky', 'validators');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\admin\\adminBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\codeconsortium\\ccdn-forum-bundle\\CCDNForum\\ForumBundle/Resources/translations\\CCDNForumForumBundle.en.yml'), 'en', 'CCDNForumForumBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\codeconsortium\\ccdn-forum-bundle\\CCDNForum\\ForumBundle/Resources/translations\\CCDNForumForumBundle.es.yml'), 'es', 'CCDNForumForumBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\codeconsortium\\ccdn-forum-bundle\\CCDNForum\\ForumBundle/Resources/translations\\CCDNForumForumBundle.fr.yml'), 'fr', 'CCDNForumForumBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\codeconsortium\\ccdn-forum-bundle\\CCDNForum\\ForumBundle/Resources/translations\\CCDNForumForumBundle.hr.yml'), 'hr', 'CCDNForumForumBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\vendor\\codeconsortium\\ccdn-forum-bundle\\CCDNForum\\ForumBundle/Resources/translations\\CCDNForumForumBundle.ru.yml'), 'ru', 'CCDNForumForumBundle');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('ccdn_forum_forum.component.twig_extension.forum_global'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\crowd\\crowdBundle/Resources/views'), 'crowd');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\admin\\adminBundle/Resources/views'), 'admin');
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\codeconsortium\\ccdn-forum-bundle\\CCDNForum\\ForumBundle/Resources/views'), 'CCDNForumForum');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'\\vendor\\codeconsortium\\ccdn-forum-bundle\\CCDNForum\\ForumBundle\\Resources\\config\\validation.yml')));
    ...
    public function getVichUploader_DownloadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.download_handler'] = new VichUploaderBundleHandlerDownloadHandler_000000000f8f27d300000000f5d76f4698a08b4058162967a59db9528264d22d(
    ...
    /**
     * Gets the 'vich_uploader.namer_uniqid.projet_file' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer A Vich\UploaderBundle\Naming\UniqidNamer instance.
     */
    protected function getVichUploader_NamerUniqid_ProjetFileService()
    {
        return $this->services['vich_uploader.namer_uniqid.projet_file'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }

    /**
     * Gets the 'vich_uploader.namer_uniqid.projet_image' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer A Vich\UploaderBundle\Naming\UniqidNamer instance.
     */
    protected function getVichUploader_NamerUniqid_ProjetImageService()
    {
        return $this->services['vich_uploader.namer_uniqid.projet_image'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }
    ...
    public function getVichUploader_UploadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.upload_handler'] = new VichUploaderBundleHandlerUploadHandler_000000000f8f27d400000000f5d76f4698a08b4058162967a59db9528264d22d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('Projet_image' => array('uri_prefix' => '\\Projet\\image', 'upload_destination' => ($this->targetDirs[5].'\\1\\uploadsProjets'), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'namer' => array('service' => 'vich_uploader.namer_uniqid.Projet_image', 'options' => array()), 'directory_namer' => NULL, 'db_driver' => 'orm'), 'Projet_file' => array('uri_prefix' => '\\Projet\\file', 'upload_destination' => ($this->targetDirs[5].'\\1\\uploadsProjets'), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'namer' => array('service' => 'vich_uploader.namer_uniqid.Projet_file', 'options' => array()), 'directory_namer' => NULL, 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'crowdBundle' => 'crowd\\crowdBundle\\crowdBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'adminBundle' => 'admin\\adminBundle\\adminBundle',
            ...
            'mailer_user' => 'adel.b.jemaa@gmail.com',
            'mailer_password' => 'jat03051993tyghbn',
            'locale' => 'fr',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'adel.b.jemaa@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'jat03051993tyghbn',
            ...
            'fos_user.model.user.class' => 'crowd\\crowdBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'adel.b.jemaa@gmail.com' => 'Example.com',
            ),
            ...
            'vich_uploader.mappings' => array(
                'Projet_image' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[5].'\\1\\uploadsProjets'),
                    'inject_on_load' => false,
                    'delete_on_update' => true,
                    'delete_on_remove' => true,
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.Projet_image',
                        'options' => array(
                ...
                'Projet_file' => array(
                    ...
                    'delete_on_remove' => true,
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.Projet_file',
                        'options' => array(
            ...
            'ccdn_forum_forum.component.twig_extension.forum_global.class' => 'CCDNForum\\ForumBundle\\Component\\TwigExtension\\ForumGlobalExtension',
            ...
            'fos_comment.model.thread.class' => 'crowd\\crowdBundle\\Entity\\Thread',
            'fos_comment.model.comment.class' => 'crowd\\crowdBundle\\Entity\\Comment',
            'fos_comment.model.vote.class' => 'crowd\\crowdBundle\\Entity\\Vote',
...
class VichUploaderBundleHandlerDownloadHandler_000000000f8f27d300000000f5d76f4698a08b4058162967a59db9528264d22d extends \Vich\UploaderBundle\Handler\DownloadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5738e3c29ab17547327042 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5738e3c29ade5446877161 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5738e3c29a2f0785039490 = array(
    ...
    {
        $this->initializer5738e3c29ade5446877161 && $this->initializer5738e3c29ade5446877161->__invoke($this->valueHolder5738e3c29ab17547327042, $this, 'downloadObject', array('object' => $object, 'field' => $field, 'className' => $className, 'fileName' => $fileName), $this->initializer5738e3c29ade5446877161);

        return $this->valueHolder5738e3c29ab17547327042->downloadObject($object, $field, $className, $fileName);
    }
    ...
    {
        $this->initializer5738e3c29ade5446877161 = $initializer;
    }
    ...
    {
        $this->initializer5738e3c29ade5446877161 && $this->initializer5738e3c29ade5446877161->__invoke($this->valueHolder5738e3c29ab17547327042, $this, '__get', array('name' => $name), $this->initializer5738e3c29ade5446877161);

        if (isset(self::$publicProperties5738e3c29a2f0785039490[$name])) {
            return $this->valueHolder5738e3c29ab17547327042->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5738e3c29ab17547327042;
    ...
    {
        $this->initializer5738e3c29ade5446877161 && $this->initializer5738e3c29ade5446877161->__invoke($this->valueHolder5738e3c29ab17547327042, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5738e3c29ade5446877161);
    ...
    {
        $this->initializer5738e3c29ade5446877161 && $this->initializer5738e3c29ade5446877161->__invoke($this->valueHolder5738e3c29ab17547327042, $this, '__isset', array('name' => $name), $this->initializer5738e3c29ade5446877161);
    ...
    {
        $this->initializer5738e3c29ade5446877161 && $this->initializer5738e3c29ade5446877161->__invoke($this->valueHolder5738e3c29ab17547327042, $this, '__unset', array('name' => $name), $this->initializer5738e3c29ade5446877161);
    ...
    {
        $this->initializer5738e3c29ade5446877161 && $this->initializer5738e3c29ade5446877161->__invoke($this->valueHolder5738e3c29ab17547327042, $this, '__clone', array(), $this->initializer5738e3c29ade5446877161);

        $this->valueHolder5738e3c29ab17547327042 = clone $this->valueHolder5738e3c29ab17547327042;
    }

    public function __sleep()
    {
        $this->initializer5738e3c29ade5446877161 && $this->initializer5738e3c29ade5446877161->__invoke($this->valueHolder5738e3c29ab17547327042, $this, '__sleep', array(), $this->initializer5738e3c29ade5446877161);

        return array('valueHolder5738e3c29ab17547327042');
    }
    ...
    {
        return $this->initializer5738e3c29ade5446877161;
    }
    ...
    {
        return $this->initializer5738e3c29ade5446877161 && $this->initializer5738e3c29ade5446877161->__invoke($this->valueHolder5738e3c29ab17547327042, $this, 'initializeProxy', array(), $this->initializer5738e3c29ade5446877161);
    }
    ...
    {
        return null !== $this->valueHolder5738e3c29ab17547327042;
    }
    ...
    {
        return $this->valueHolder5738e3c29ab17547327042;
    }


}

class VichUploaderBundleHandlerUploadHandler_000000000f8f27d400000000f5d76f4698a08b4058162967a59db9528264d22d extends \Vich\UploaderBundle\Handler\UploadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5738e3c2a49c5454977826 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5738e3c2a4a02881566741 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5738e3c2a4954732157223 = array(
    ...
    {
        $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, 'upload', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5738e3c2a4a02881566741);

        return $this->valueHolder5738e3c2a49c5454977826->upload($obj, $fieldName);
    }
    ...
    {
        $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, 'inject', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5738e3c2a4a02881566741);

        return $this->valueHolder5738e3c2a49c5454977826->inject($obj, $fieldName);
    }
    ...
    {
        $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, 'clean', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5738e3c2a4a02881566741);

        return $this->valueHolder5738e3c2a49c5454977826->clean($obj, $fieldName);
    }
    ...
    {
        $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, 'remove', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5738e3c2a4a02881566741);

        return $this->valueHolder5738e3c2a49c5454977826->remove($obj, $fieldName);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer5738e3c2a4a02881566741 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, '__get', array('name' => $name), $this->initializer5738e3c2a4a02881566741);

        if (isset(self::$publicProperties5738e3c2a4954732157223[$name])) {
            return $this->valueHolder5738e3c2a49c5454977826->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5738e3c2a49c5454977826;
    ...
    public function __set($name, $value)
    {
        $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5738e3c2a4a02881566741);
    ...
    public function __isset($name)
    {
        $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, '__isset', array('name' => $name), $this->initializer5738e3c2a4a02881566741);
    ...
    public function __unset($name)
    {
        $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, '__unset', array('name' => $name), $this->initializer5738e3c2a4a02881566741);
    ...
    public function __clone()
    {
        $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, '__clone', array(), $this->initializer5738e3c2a4a02881566741);

        $this->valueHolder5738e3c2a49c5454977826 = clone $this->valueHolder5738e3c2a49c5454977826;
    }

    public function __sleep()
    {
        $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, '__sleep', array(), $this->initializer5738e3c2a4a02881566741);

        return array('valueHolder5738e3c2a49c5454977826');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5738e3c2a4a02881566741;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer5738e3c2a4a02881566741 && $this->initializer5738e3c2a4a02881566741->__invoke($this->valueHolder5738e3c2a49c5454977826, $this, 'initializeProxy', array(), $this->initializer5738e3c2a4a02881566741);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5738e3c2a49c5454977826;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5738e3c2a49c5454977826;
    }
