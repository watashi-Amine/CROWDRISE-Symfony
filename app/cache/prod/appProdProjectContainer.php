...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('Projet_file', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('Projet_image', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('Projet_file', $c, $a, $b));
        $d->addEventSubscriber(new \FOS\UserBundle\Doctrine\UserListener($this));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('Projet_image', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('Projet_image', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('Projet_file', $c, $a, $b));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'bk', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\crowd\\crowdBundle\\Entity'))), 'crowd\\crowdBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('crowdBundle' => 'crowd\\crowdBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ecc6f618213e6554887f74613580581a5465ff1597c9ee33dd9dee2046774a77');
        return $instance;
    }
    ...
    public function getVichUploader_DownloadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['vich_uploader.download_handler'] = new VichUploaderBundleHandlerDownloadHandler_000000007806fff600000000d8b76e52(
    ...
    {
        return $this->services['vich_uploader.form.type.file'] = new \Vich\UploaderBundle\Form\Type\VichFileType($this->get('vich_uploader.storage'), $this->get('vich_uploader.upload_handler'), $this->get('translator.default'));
    }
    protected function getVichUploader_Form_Type_ImageService()
    {
        return $this->services['vich_uploader.form.type.image'] = new \Vich\UploaderBundle\Form\Type\VichImageType($this->get('vich_uploader.storage'), $this->get('vich_uploader.upload_handler'), $this->get('translator.default'));
    }
    ...
    public function getVichUploader_UploadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['vich_uploader.upload_handler'] = new VichUploaderBundleHandlerUploadHandler_000000007806fffb00000000d8b76e52(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
        ...
        return new \Vich\UploaderBundle\Handler\UploadHandler($this->get('vich_uploader.property_mapping_factory'), $a, new \Vich\UploaderBundle\Injector\FileInjector($a), $this->get('event_dispatcher'));
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('Projet_image' => array('uri_prefix' => '\\Projet\\image', 'upload_destination' => ($this->targetDirs[4].'\\1\\uploadsProjets'), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'namer' => array('service' => 'vich_uploader.namer_uniqid.Projet_image', 'options' => array()), 'directory_namer' => NULL, 'db_driver' => 'orm'), 'Projet_file' => array('uri_prefix' => '\\Projet\\file', 'upload_destination' => ($this->targetDirs[4].'\\1\\uploadsProjets'), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'namer' => array('service' => 'vich_uploader.namer_uniqid.Projet_file', 'options' => array()), 'directory_namer' => NULL, 'db_driver' => 'orm')), '_name');
    }
        ...
        return array(
            ...
            'vich_uploader.mappings' => array(
                'Projet_image' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[4].'\\1\\uploadsProjets'),
...
class VichUploaderBundleHandlerDownloadHandler_000000007806fff600000000d8b76e52 extends \Vich\UploaderBundle\Handler\DownloadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5734bad575186894850758 = null;
    private $initializer5734bad57545a049462312 = null;
    private static $publicProperties5734bad5746d5440822549 = array(
        
    );
    public function downloadObject($object, $field, $className = null, $fileName = null)
    {
        $this->initializer5734bad57545a049462312 && $this->initializer5734bad57545a049462312->__invoke($this->valueHolder5734bad575186894850758, $this, 'downloadObject', array('object' => $object, 'field' => $field, 'className' => $className, 'fileName' => $fileName), $this->initializer5734bad57545a049462312);
        return $this->valueHolder5734bad575186894850758->downloadObject($object, $field, $className, $fileName);
    }
    public function __construct($initializer)
    {
        $this->initializer5734bad57545a049462312 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5734bad57545a049462312 && $this->initializer5734bad57545a049462312->__invoke($this->valueHolder5734bad575186894850758, $this, '__get', array('name' => $name), $this->initializer5734bad57545a049462312);
        if (isset(self::$publicProperties5734bad5746d5440822549[$name])) {
            return $this->valueHolder5734bad575186894850758->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5734bad575186894850758;
    ...
    {
        $this->initializer5734bad57545a049462312 && $this->initializer5734bad57545a049462312->__invoke($this->valueHolder5734bad575186894850758, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5734bad57545a049462312);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5734bad575186894850758;
    ...
    {
        $this->initializer5734bad57545a049462312 && $this->initializer5734bad57545a049462312->__invoke($this->valueHolder5734bad575186894850758, $this, '__isset', array('name' => $name), $this->initializer5734bad57545a049462312);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5734bad575186894850758;
    ...
    {
        $this->initializer5734bad57545a049462312 && $this->initializer5734bad57545a049462312->__invoke($this->valueHolder5734bad575186894850758, $this, '__unset', array('name' => $name), $this->initializer5734bad57545a049462312);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5734bad575186894850758;
    ...
    {
        $this->initializer5734bad57545a049462312 && $this->initializer5734bad57545a049462312->__invoke($this->valueHolder5734bad575186894850758, $this, '__clone', array(), $this->initializer5734bad57545a049462312);
        $this->valueHolder5734bad575186894850758 = clone $this->valueHolder5734bad575186894850758;
    }
    public function __sleep()
    {
        $this->initializer5734bad57545a049462312 && $this->initializer5734bad57545a049462312->__invoke($this->valueHolder5734bad575186894850758, $this, '__sleep', array(), $this->initializer5734bad57545a049462312);
        return array('valueHolder5734bad575186894850758');
    }
    ...
    {
        return $this->initializer5734bad57545a049462312;
    }
    public function initializeProxy()
    {
        return $this->initializer5734bad57545a049462312 && $this->initializer5734bad57545a049462312->__invoke($this->valueHolder5734bad575186894850758, $this, 'initializeProxy', array(), $this->initializer5734bad57545a049462312);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5734bad575186894850758;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5734bad575186894850758;
    }
}
class VichUploaderBundleHandlerUploadHandler_000000007806fffb00000000d8b76e52 extends \Vich\UploaderBundle\Handler\UploadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5734bad58004c093553558 = null;
    private $initializer5734bad580091982892192 = null;
    private static $publicProperties5734bad57ffc9248498255 = array(
        
    );
    public function upload($obj, $fieldName)
    {
        $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, 'upload', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5734bad580091982892192);
        return $this->valueHolder5734bad58004c093553558->upload($obj, $fieldName);
    }
    public function inject($obj, $fieldName)
    {
        $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, 'inject', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5734bad580091982892192);
        return $this->valueHolder5734bad58004c093553558->inject($obj, $fieldName);
    }
    public function clean($obj, $fieldName)
    {
        $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, 'clean', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5734bad580091982892192);
        return $this->valueHolder5734bad58004c093553558->clean($obj, $fieldName);
    }
    public function remove($obj, $fieldName)
    {
        $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, 'remove', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5734bad580091982892192);
        return $this->valueHolder5734bad58004c093553558->remove($obj, $fieldName);
    }
    public function __construct($initializer)
    {
        $this->initializer5734bad580091982892192 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, '__get', array('name' => $name), $this->initializer5734bad580091982892192);
        if (isset(self::$publicProperties5734bad57ffc9248498255[$name])) {
            return $this->valueHolder5734bad58004c093553558->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5734bad58004c093553558;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5734bad580091982892192);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5734bad58004c093553558;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, '__isset', array('name' => $name), $this->initializer5734bad580091982892192);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5734bad58004c093553558;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, '__unset', array('name' => $name), $this->initializer5734bad580091982892192);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5734bad58004c093553558;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, '__clone', array(), $this->initializer5734bad580091982892192);
        $this->valueHolder5734bad58004c093553558 = clone $this->valueHolder5734bad58004c093553558;
    }
    public function __sleep()
    {
        $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, '__sleep', array(), $this->initializer5734bad580091982892192);
        return array('valueHolder5734bad58004c093553558');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5734bad580091982892192;
    }
    public function initializeProxy()
    {
        return $this->initializer5734bad580091982892192 && $this->initializer5734bad580091982892192->__invoke($this->valueHolder5734bad58004c093553558, $this, 'initializeProxy', array(), $this->initializer5734bad580091982892192);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5734bad58004c093553558;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5734bad58004c093553558;
    }
}
